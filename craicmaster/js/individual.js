   ...
   FB.api('/me?fields=id,first_name,last_name,gender,email,picture', function(response) {
      console.log('Successful login for: ' + response.name);
       ...
       document.getElementById('status').innerHTML =
        'Welcome to Wheres The Craic App, ' + response.first_name + '! :) ';
       
       //taking user info from FB and show it on user profile page
        document.getElementById('uName').innerHTML = response.first_name;
       
        document.getElementById('uLast').innerHTML = response.last_name;
       
       document.getElementById('uGen').innerHTML = response.gender;  
       
       document.getElementById('uEmail').innerHTML = response.email;
       document.getElementById('Upicture').innerHTML= "<img src=" + image + ">";
       
    
       //if (userLocation) 
       //document.getElementById('uLocation').innerHTML = birthday;   
       //else   
       //document.getElementById('uLocation').innerHTML = 'nada';
